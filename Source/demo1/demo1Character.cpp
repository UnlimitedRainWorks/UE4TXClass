...
void Ademo1Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &Ademo1Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &Ademo1Character::TouchStopped);
...
{
	// If demo1 is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in demo1.Build.cs is not automatically propagated
...
void Ademo1Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void Ademo1Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
